...
function Router() {
  return <Switch><Route path="/" component={Home} /><Route path="/about" component={About} /><Route path="/weddings-events" component={WeddingsEvents} /><Route path="/nature" component={Nature} /><Route path="/selected-work" component={SelectedWork} /><Route path="/prints" component={Prints} /><Route path="/inquire" component={Inquire} /><Route path="/journal" component={Journal} /><Route component={NotFound} /></Switch>;
}
