  ...
  return (
    <PageFrame>
      ...
      <main className="paper-page">
        ...
        <section className="weddings-intro editorial-section"><div><SectionTag>A considered record</SectionTag></div><div><p className="large-copy">A day can move quickly. The photographs are made to bring you back to the look across the room, the light over the desert, and the people who showed up.</p><p>Otterfocus photographs weddings and meaningful events in Las Vegas and the desert surrounds with an approach that is calm, observant, and grounded in the real texture of the day.</p><div className="service-links"><TextLink href="/inquire">Inquire about your date</TextLink><TextLink href="/pricing">Pricing guidance</TextLink><TextLink href="/faq">Read the FAQs</TextLink></div></div></section>
